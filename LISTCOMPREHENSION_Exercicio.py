...
lista_vendasprodutos2019 = [(vendas2019, produto)
                            for produto, vendas2019, vendas2020 in vendas_produtos]
...
clientes_inadimplentes_2 = [cpf for cpf, valor,
                            dias in clientes_devedores if dias > 20]
...
for produto, qtd in estoque:
    if qtd < 200:
        lista_estoque.append(1000)
    else:
        lista_estoque.append(500)
print(lista_estoque)

lista_estoque_2 = [1000 if qtd < 200 else 500 for produto, qtd in estoque]
print(lista_estoque_2)
