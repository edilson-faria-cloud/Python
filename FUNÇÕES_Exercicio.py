...
def separar_listas(precos, tamanhos, fator=0.1):
    if len(precos) == len(tamanhos):
        ...
        precos_imoveis_treino = precos_imoveis[:i]
        ...
        print('As listas de preçoes e tamanhos dos imoveis não tem a mesma quantidade de itens')
        return


print(len(precos_imoveis))
precos_treino, precos_teste, tamanho_treino, tamanho_teste = separar_listas(
    precos_imoveis, tamanho_imoveis)
...
def listar_produtos(*listas):
    ...
    listar_produtos = set(listar_produtos)
    listar_produtos = list(listar_produtos)
